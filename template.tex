\ctexset{
  section={
    ...
    format += \centering \bfseries \zihao{3} \setcounter{figure}{0} \setcounter{table}{0} \setcounter{equation}{0}
   },
  subsection={
...
\usepackage[hidelinks, bookmarksnumbered=true]{hyperref} %目录、文献跳转
\usepackage{graphicx}
\usepackage{caption}
...
\setlength{\bibsep}{0\baselineskip} %缩短两个参考文献之间的间距