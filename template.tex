\ctexset{
  section={
    ...
    format += \centering \fontspec{SimSun} \bfseries \zihao{3} \setcounter{figure}{0} \setcounter{table}{0} \setcounter{equation}{0}
   },
  subsection={
  number =  \arabic{section}.\arabic{subsection} ,
  format += \fontspec{SimSun} \bfseries \zihao{4},
  indent = 2em,
...
\usepackage[hidelinks, backref, bookmarksnumbered=true]{hyperref} %目录、文献跳转
\usepackage{graphicx}
\usepackage{caption}
...
\usepackage{pdfpages} %pdfpages与xcolor带有一定冲突必须放在其后面
% 在导言区进行样式设置
\lstset{
